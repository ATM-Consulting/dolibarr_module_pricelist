...
class pricelist extends SeedObject
{
	...
	public static $TStatus = array(
		self::STATUS_CANCELED => 'pricelistStatusShortCanceled'
		,self::STATUS_DRAFT => 'pricelistStatusShortDraft'
		,self::STATUS_VALIDATED => 'pricelistStatusShortValidated'
//		,self::STATUS_REFUSED => 'pricelistStatusShortRefused'
//		,self::STATUS_ACCEPTED => 'pricelistStatusShortAccepted'
	);
...
//        ),
    ...
    private function getNextRef()
    {
		...
		$mask = !empty($conf->global->PRICELIST_REF_MASK) ? $conf->global->PRICELIST_REF_MASK : 'MM{yy}{mm}-{0000}';
		$ref = get_next_value($db, $mask, 'pricelist', 'ref');
...
//        $picto='pricelist@pricelist';
    ...
    public static function LibStatut($status, $mode)
    {
        ...
        if ($status==self::STATUS_CANCELED) { $statusType='status9'; $statusLabel=$langs->trans('pricelistStatusCancel'); $statusLabelShort=$langs->trans('pricelistStatusShortCancel'); }
        elseif ($status==self::STATUS_DRAFT) { $statusType='status0'; $statusLabel=$langs->trans('pricelistStatusDraft'); $statusLabelShort=$langs->trans('pricelistStatusShortDraft'); }
        elseif ($status==self::STATUS_VALIDATED) { $statusType='status1'; $statusLabel=$langs->trans('pricelistStatusValidated'); $statusLabelShort=$langs->trans('pricelistStatusShortValidate'); }
        elseif ($status==self::STATUS_REFUSED) { $statusType='status5'; $statusLabel=$langs->trans('pricelistStatusRefused'); $statusLabelShort=$langs->trans('pricelistStatusShortRefused'); }
        elseif ($status==self::STATUS_ACCEPTED) { $statusType='status6'; $statusLabel=$langs->trans('pricelistStatusAccepted'); $statusLabelShort=$langs->trans('pricelistStatusShortAccepted'); }
...
//class pricelistDet extends SeedObject
//{
//    public $table_element = 'pricelistdet';
//
//    public $element = 'pricelistdet';
//
//
//    /**
//     * pricelistDet constructor.
//     * @param DoliDB    $db    Database connector
//     */
//    public function __construct($db)
//    {
