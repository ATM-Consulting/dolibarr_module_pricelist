 ...
 */
class pricelistbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "pricelist@pricelist";
    public $boxlabel;
    public $depends = array("pricelist");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/pricelist/class/pricelist.class.php";
